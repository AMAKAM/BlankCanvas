...
data Intersection =   Top | Bottom | Vertical | NoIntersection | Wrong 	
			deriving (Show)
																...
																calculateIntersection context = 
																		...
																		do
																			send context ( do
																				...
																				putOnScreen ["magV",show (magV)] (10,190)
																				putOnScreen ["deviationFactor ",show (deviationFactor)] (10,205)
																				putOnScreen ["returnAngle ",show (returnAngle)] (10,220)
																				putOnScreen ["returnAngle1 ",show (returnAngle1)] (10,235)
																				putOnScreen ["returnX",show (returnX)] (10,250)
																				putOnScreen ["returnY ",show (returnY)] (10,265)
																				putOnScreen ["finalReturnVectorX ",show (finalReturnVectorX)] (10,280)
																				putOnScreen ["finalReturnVectorY ",show (finalReturnVectorY)] (10,295)
																				restore ()
																			...
																			where
																				...
																				(returnLine,returnBool,maybeIntersection,ref)= case element of
																							  		Just 0 -> (hLineTop,boolHLineTop,Top,1)
																									Just 1 -> (hLineBottom,boolHLineBottom,Bottom,2)
